...
const Footer = () => {
    ...
    return (
        <>
            <div className="rounded-full h-14 aspect-square bg-green-600 flex justify-center items-center m-4 sticky bottom-0 left-full -translate-y-3 -translate-x-3 text-white text-2xl shadow-lg leading-[normal]"><IoChatboxEllipses /></div>
